<template>
    <div>
        ...
        <el-table :data="tableData" stripe highlight-current-row border v-loading="listLoading"
            ...
            <el-table-column prop="roleids" label="用户角色" align="center">
            </el-table-column>
            <el-table-column prop="gasList" label="拥有加油站" align="center">
            </el-table-column>
        ...
        <el-dialog title="编辑" v-model="editFormVisible" :close-on-click-modal="false">
            <el-form :model="editForm" label-width="120px" :rules="editFormRules" ref="editForm" style="margin-right:50px">
        ...
        <el-dialog title="新增" v-model="addFormVisible" :close-on-click-modal="false">
            <el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm" style="margin-right:50px">
                ...
                <el-form-item label="选择加油站" prop="gasIds">
                    <el-select v-model="addForm.gasIds" multiple placeholder="请选择" style="width:100%;">
                        <el-option
            ...
            this.$refs[formName].validate((valid) => {
                if (valid) {
                    this.$confirm('确认提交吗？', '提示', {}).then(() => {
                        ...
                        para.gasIds=this.addForm.gasIds.toString();
