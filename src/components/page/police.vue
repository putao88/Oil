<template>
    <div>
        ...
        <el-table :data="tableData" stripe highlight-current-row border v-loading="listLoading"
            ...
            <el-table-column prop="tid" label="油罐名称" align="center" width="120"></el-table-column>
            ...
            <el-table-column prop="current" label="当前油位(mm)" align="center" sortable width="160"></el-table-column>
            ...
            <el-table-column prop="check" label="是否处理" width="140">
